...
public class MechanumDriveSubsystem extends SidedDriveSystemTemplate {
    ...
    public static final String ID = "MechanumWheelDrive";
    ...
    public MechanumDriveSubsystem setMotorNames(String leftFront, String rightFront, String leftBack, String rightBack) {
    ...
    public MechanumDriveSubsystem setUsingEncoders(boolean usingEncoders) {
